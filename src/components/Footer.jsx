...
const Footer = () => {
  return (
    <>
      <footer className='bg-[#e9e9e9a1] py-8 mt-10'>
        <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-1">
            <h1 className='text-[22px] font-normal mb-2'>Products</h1>
            <ul>
              <li className='text-[18px] text-gray-600 mb-1'>Milk</li>
              <li className='text-[18px] text-gray-600 mb-1'>Ghee</li>
              <li className='text-[18px] text-gray-600 mb-1'>Paneer</li>
              <li className='text-[18px] text-gray-600 mb-1'>Curd</li>
              <li className='text-[18px] text-gray-600 mb-1'>ButterMilk</li>
            </ul>
          </div>
          <div className="lg:col-span-1">
          ...
          <div className="lg:col-span-1">
            ...
            <ul>
              <li className='text-[16px] text-gray-600 flex items-start mb-3'>
                <i className="fi fi-rs-marker mr-2 mt-1"></i> 201 Purani Basti, <br/>Naubasta, Kanpur Nagar - 208021
              </li>
              <li className='text-[16px] text-gray-600 flex items-start mb-3'>
                <i className="fi fi-rs-envelope mr-2 mt-1"></i> support@dairydelight.com
              </li>
              <li className='text-[16px] text-gray-600 flex items-start'>
                <i className="fi fi-ts-phone-call mr-2 mt-1"></i> 7355732435 | 9998882221
              </li>
            </ul>
          </div>
        </div>
